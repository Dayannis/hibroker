...
if (!function_exists('shieldgroup_trx_addons_get_css')) {
	add_filter('shieldgroup_filter_get_css', 'shieldgroup_trx_addons_get_css', 10, 4);
	function shieldgroup_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
