		...
		?>>
			...
			if (!empty($item['image'])) {
				...
				if (!empty($item['image'])) {
					...
					?><div class="sc_price_item_image"><img src="<?php echo esc_url($item['image']); ?>" alt="<?php echo esc_html(basename($item['image'])); ?>"<?php echo (!empty($attr[3]) ? ' '.trim($attr[3]) : ''); ?>></div><?php
				}
			} else {
				...
				if (!empty($item['description'])) {
					...
					?></div><?php
                            ...
                            if (!empty($item['price'])) {
                                ...
                                ?><span class="sc_price_item_price_value"><?php echo wp_kses_post($item['price']); ?></span><?php
