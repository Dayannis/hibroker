...
?>>
	<div class="sc_services_item_info">
		<div class="sc_services_item_header">
            ...
            <h5 class="sc_services_item_title<?php if (!$price_showed && !empty($meta['price'])) echo ' with_price'; ?>"><a href="<?php echo esc_url($link); ?>"><?php
				the_title();
				// Price
        ...
        ?>
    </div><div class="serv-image">
    <?php
    if (isset($meta['descript'])) {
        ?><a href="<?php echo esc_url($link); ?>"><div class="sc_services_item_descr"><div><?php echo wp_kses_data($meta['descript']); ?></div></div></a>
    <?php }
    ...
    if ( has_post_thumbnail() && $args['featured']=='image') {
        trx_addons_get_template_part('templates/tpl.featured.php',
            ...
            apply_filters('trx_addons_filter_args_featured', array(
                ...
                'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size($args['columns'] > 2 ? 'serv' : 'big'), 'services-default'),
