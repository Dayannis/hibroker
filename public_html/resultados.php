...
if($datos_correctos==1){
  ...
  $productosResult .= '<th>EDAD ASEGURABLE</th>';
  ...
  if(@mysqli_num_rows($productos)>0 && $menor == 0 ){
   ...
   if($tomador){
    ...
    $edadesList = array($sp->CalculaEdad($sp->limpiarFechaNac($_POST["fecha_nac"])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][0])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][1])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][2])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][3])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][4])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][5])));}
     ...
     $edadesList = array($sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][0])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][1])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][2])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][3])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][4])), $sp->CalculaEdad($sp->limpiarFechaNac($_POST["fechanac"][5])));
    }
    ...
    foreach ($productosList as $key => $value) 
    {
        ...
        $productosResult .= '<td align="center">' .$edadList[$key].'</td>';              
  ...
  $productosResult .='<br>';
  //$productosResult .='<p>Caso A: '.json_encode($_POST).'</p>';
  ...
  if(@mysqli_num_rows($productos)>0 && $menor == 0){
    ...
    foreach ($productosList as $key => $value) { 
        ...
        $productosResult2 .='<b>EDAD ASEGURABLE: </b>'.	 $edadList[$key] . '<br>';
  ...
  $productosResult2 .='</div>';
  $productosResult2 .='<br><br>';
//  $productosResult .='<p>Caso B: '.json_encode($_POST).'</p>';
